...
- 과제 내용
 ...
 - C버튼 구현 : 현재의 모든 내용을 삭제
	

 - CE버튼 구현 : 마지막 입력한 피연산자 값을 삭제


 - Del 버튼 구현: 마지막 입력된 글자 하나 값을 삭제
	

- 구현 내용과 기능 설명


 - C버튼을 누르면 현재 모든 내용을 삭제하고 처음 상태로 돌아간다.
	

 - CE 버튼을 누르면 마지막 입력한 피연산자 값을 삭제한다.
	- 256을 입력후에 CE버튼을 누르면 256이 통째로 삭제된다.
	

 - Del 버튼을 누르면 마지막 입력된 글자 하나를 삭제한다.
	- 100입력 후에 Del 버튼을 누르면 0이 삭제되고 10이 남는다.
